package neo4j.resources;

import neo4j.constants.NsConstant;
...
public class BlockResource extends AbstractResource {
    ...
    @OslcPropertyDefinition(NsConstant.oslc_XMI_TYPE)
    ...
    @OslcPropertyDefinition(NsConstant.oslc_XMI_ID)
    ...
    @OslcPropertyDefinition(NsConstant.oslc_VISIBILITY)
